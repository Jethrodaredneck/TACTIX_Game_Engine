...
public sealed class HierarchyPanelView : NSView
{
    ...
    {
        _scene=scene; _world=scene.World; _selection=selection; _commands=commands;
    ...
    private void Load(){SceneSerializer.LoadInto(_scene,_scenePath);_selection.Select(_world.Entities.FirstOrDefault());}
